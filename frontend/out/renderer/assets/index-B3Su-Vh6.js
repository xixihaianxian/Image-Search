const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./SearchView-B_U-_jN0.js","./SearchView-CfWDMat4.css"])))=>i.map(i=>d[i]);
// @__NO_SIDE_EFFECTS__
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        _cache[0] || (_cache[0] = createBaseVNode("div", {
          class: "bg-blob bg-blob--indigo",
          "aria-hidden": "true"
        }, null, -1)),
        _cache[1] || (_cache[1] = createBaseVNode("div", {
          class: "bg-blob bg-blob--sky",
          "aria-hidden": "true"
        }, null, -1)),
        _cache[2] || (_cache[2] = createBaseVNode("div", {
          class: "bg-blob bg-blob--rose",
          "aria-hidden": "true"
        }, null, -1)),
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-86f9abad"]]);
...
const _hoisted_1 = { class: "status__text" };
const API_URL = "http://127.0.0.1:8000/ImageSearch";
const _sfc_main = {
  __name: "HomeView",
  setup(__props) {
    const router2 = useRouter();
    const backendStatus = /* @__PURE__ */ ref("checking");
    ...
    function handleEnter() {
      router2.push({ name: "search" });
    }
    onMounted(checkBackend);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("main", { class: "hero" }, [
          _cache[1] || (_cache[1] = createBaseVNode("p", { class: "hero__eyebrow" }, "AI · IMAGE RETRIEVAL", -1)),
          _cache[2] || (_cache[2] = createBaseVNode("h1", { class: "hero__title" }, [
            createTextVNode(" Image"),
            createBaseVNode("span", { class: "hero__title-accent" }, "Search")
          ], -1)),
          _cache[3] || (_cache[3] = createBaseVNode("p", { class: "hero__subtitle" }, "基于深度学习的图片检索", -1)),
          createBaseVNode("button", {
            class: "enter-btn",
            type: "button",
            onClick: handleEnter
          }, [..._cache[0] || (_cache[0] = [
            createBaseVNode("span", { class: "enter-btn__text" }, "进 入", -1),
            createBaseVNode("span", {
              class: "enter-btn__arrow",
              "aria-hidden": "true"
            }, "→", -1)
          ])])
        ]),
        createBaseVNode("footer", {
          class: normalizeClass(["status", `status--${backendStatus.value}`])
        }, [
          _cache[4] || (_cache[4] = createBaseVNode("span", {
            class: "status__dot",
            "aria-hidden": "true"
          }, null, -1)),
          createBaseVNode("span", _hoisted_1, toDisplayString(statusText.value), 1)
        ], 2)
      ], 64);
    };
  }
};
const HomeView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-01647f3b"]]);
const router = createRouter({
  ...
  routes: [
    { path: "/", name: "home", component: HomeView },
    {
      path: "/search",
      name: "search",
      component: () => __vitePreload(() => import("./SearchView-B_U-_jN0.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url)
    }
  ]
});
